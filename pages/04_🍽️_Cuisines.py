...
def top_worst_cuisines(top_n, countries):
    ...
    fig.update_layout(title_text=f'Top {top_n} Piores Tipos de Culinárias', title_x=0.3)
...
def top_best_cuisines(top_n, countries):
            ...
            fig.update_layout(title_text=f'Top {top_n} Melhores Tipos de Culinárias', title_x=0.3)
            fig.update_traces(marker_line_color = 'rgb(8,48,107)', marker_line_width = 1.5)
...
st.write(f'## Top {top_n} Restaurantes')
